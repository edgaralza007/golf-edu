    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex flex-wrap gap-3 justify-center pb-8">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg border-2 border-red-300 px-5 py-2.5 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
